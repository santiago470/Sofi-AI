...
export default async function (req, res) { 
    ...
    try {
        ...
        if (mode === ChatMode.Psychologist) {
            ...
            - NUNCA dês conselhos diretos. Em vez disso, faz perguntas abertas para ajudar o utilizador a explorar os seus próprios sentimentos e a encontrar as suas próprias soluções (ex: "E como é que isso te fez sentir?", "O que pensas que podes fazer em relação a isso?").
